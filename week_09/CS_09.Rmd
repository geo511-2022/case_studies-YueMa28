...
In this part we filter out the data and prepare it for the visualization.
...
In this part we create the table that shows the top five states attacked by the storms from 1950 to present.
